...
#----------------------需要設定的參數----------------------------------------------
#檔名參數
file_name='ANN_training_data_AC_combination_0116_removeDC_32'
#輸入特徵參數
features_Num = 32 #要取的column數，也就是輸入變數
#輸入訓練次數
iteration = 30000
#輸入隱藏層特徵數
...
#移除不需要的參數
#columnDrop = ['940nm-Hypotenuse','970nm-Hypotenuse','1200nm-Hypotenuse','1300nm-Hypotenuse',
#             '940nm-Theta','970nm-Theta','1200nm-Theta','1300nm-Theta']
#columnDrop = ['940nm-Hypotenuse','970nm-Hypotenuse',
#              '940nm-Theta','970nm-Theta']
#df0.drop(columnDrop, axis=1)
